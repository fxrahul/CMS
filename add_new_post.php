...
require 'conn.php';
  if(isset($_POST['add_post'])){
    ...
    $sql="INSERT into admin_panel VALUES ('','$DateTime','$Title','$Category','$Admin_name','$Image','$Post')";
    ...
    $_SESSION['msg']='<div id="status" class="modal" style="z-index: 1003; display: none; opacity: 0; transform: scaleX(0.7); top: 4%;">
        ...
        header('Location:add_new_post.php');
        exit;
  }
 ?>
<!DOCTYPE html>
   ...
   <div class="row no-margin" style="height:75%">
        ...
        <!-- Grey navigation panel
          ...
          12-columns-wide on small screens  -->
                ...
                <a href="add_new_post.php" class="collection-item active  ">Add new post</a>
...
?>
    ...
    <form class="col s12" method="post" action="add_new_post.php" enctype="multipart/form-data">
      <div>
        <div class="input-field col l4 offset-l4 s12">
          <input id="title" type="text" data-length="200" name="Title" required maxlength="200" minlength="2">
    ...
    <label>Select Category</label>
      ...
      <div >
        <div class="input-field col l4 offset-l4 s12">
          <textarea id="post" data-length="10000" maxlength="10000" required name="Post" class="materialize-textarea"></textarea>
          ...
          <div >
          <div class="input-field col l4 offset-l4 s12">
            <button class="btn waves-effect waves-light right  " type="submit" name="add_post">Add new post
