...
require 'conn.php';
  ...
  if(isset($_POST['update_post'])){
    ...
    $sql="UPDATE admin_panel SET `datetime`='$DateTime',title='$Title', category='$Category',author='$Admin_name' ,image='$Image',post='$Post' WHERE id='$PostId'";
...
?>
      ...
      ?> 
    <form class="col s12" method="post" action="edit_post.php" enctype="multipart/form-data">
      <input type="hidden" name="id" value="<?php echo $PostId; ?>">
        <div class="input-field col l4 offset-l4 s12">
          <input value="<?php echo $TitleToBeUpdated; ?>" id="title" type="text" data-length="200" name="Title" required maxlength="200" minlength="2">
    ...
    <label>Select New Category &nbsp;&nbsp;&nbsp;Existing Category:&nbsp;<?php echo $CategoryToBeUpdated; ?></label>
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate"  required placeholder="Choose image" type="text">
      </div>
    </div>
    
      
        <div class="input-field col l4 offset-l4 s12">
          <textarea id="post" data-length&nbsp;<?php echo $CategoryToBeUpdated; ?>="10000" maxlength="10000" required name="Post" class="materialize-textarea">
          ...
          <div class="input-field col l4 offset-l4 s12">
            <button class="btn waves-effect waves-light right  " type="submit" name="update_post">Update Post
